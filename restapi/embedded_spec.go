...
func init() {
  ...
  "paths": {
    ...
    "/clusters/{cluster_id}/downloads/image.iso": {
      "get": {
        "security": [
          {
            "userAuth": [
        ...
        "description": "Downloads the OpenShift per-cluster Discovery ISO. Provided for compatability with Dell IDRAC.",
        "produces": [
          "application/octet-stream"
        ],
        "tags": [
        ...
        "operationId": "DownloadClusterISOClone",
        "parameters": [
          {
            "type": "string",
            "format": "uuid",
      ...
      "head": {
        ...
        "operationId": "DownloadClusterISOHeadersClone",
        "parameters": [
          {
            "type": "string",
            "format": "uuid",
